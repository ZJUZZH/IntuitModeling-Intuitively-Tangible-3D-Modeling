...
char imu_data[47] = "no data"; // must be initialized  
...
//此处需手动修改从机软件I2C地址
#define soft_I2C_SLAVE_ADDRESS 12

int addr = soft_I2C_SLAVE_ADDRESS;
...
void ReadIMUbyDMP()
{
    ...
    else if (mpuIntStatus & 0x02) 
    {
        ...
        dataConversion(q.w, q.x, q.y, q.z, aaReal.x, aaReal.y, aaReal.z);  
    }
  }


// This function would convert and merge the quaternion into the imu_data[](char)
void dataConversion(float qw, float qx, float qy, float qz, float accx, float accy, float accz)
{
  ...
  char data[47] = ""; //must be initialized
  char addstr[2] = "";
